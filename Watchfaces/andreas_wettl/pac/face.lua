...
function init()
    ...
    local rightPellets1 = atlas:createIndexedSprite("pellets")
...
function update()
    ...
    pacmanClosed:setVisible(0 == second % 2)
    pacmanOpen:setVisible(1 == second % 2)
    halfDisc:setRotation(360 / 60 * second + 180)
    rightPellets:setVisible(second < 30)
    leftPellets:setVisible(second < 30)
end